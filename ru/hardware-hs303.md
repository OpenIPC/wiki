...
- второй раздел оставьте неразмеченным и не отформатированным
...
$\color{red}{\texttt{Внимание !}}$

_В связи с проведением работ по модернизации структуры прошивки, пожалуйста НЕ выполняйте 
писанное ниже системное обновления до того момента, когда пропадет данное сообщение._
