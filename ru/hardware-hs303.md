...
если произойдет случайный или преднамеренный сброс на заводские настройки.
...
#### Особенности релиза (на 2022.08.08)

- что-бы устройство работало максимально стабильно, по-умолчанию отключены 
  дополнительные сервисы и службы: HLS, OSD, Motion и RTSP суб-посток;
