...
* Программатор SPI NOR флеш памяти. В принципе можно обойтись без него средствами проекта [burn](https://github.com/OpenIPC/burn), который позволяет заливать систему в пустой/убитый флеш.
...
* Выключите камеру, отпаяйте оригинальную 8 мегабайтную SPI NOR флеш микросхему и сделайте ее дамп с помощью программатора.
* Залейте дамп в новую 16 мегабайтную флеш (в первые 8 мегабайт) и припаяйте его на плату. Проверьте, что камера запускается и работает
