...
При первом заходе в веб-интерфейс камеры (порт 80) будет предложено сменить MAC в автоматическом режиме с возможностью указать свой или сгенерировать его по всем правилам автоматически.
